...
wss.on('connection',ws=>{
  ...
  ws.on('message',async raw=>{
    ...
    if(m.type==='server_automation_sync'){automation.update(m);return safeSend(ws,{type:'server_automation_status',ok:true,provider:'cloudflare',code:automation.code,ready:automation.ready,game:automation.game,configured:automation.configured})}
